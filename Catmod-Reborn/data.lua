...
-- #### CAT UNIT SETUP AREA ####
    {
        ...
        icon_size = 128,
        flags = {"placeable-player", "placeable-off-grid", "breaths-air", "not-repairable", "player-creation", "not-repairable"},
        ...
        working_sound = {
          sound = {filename = "__Catmod-Reborn__/sound/meow3.ogg", volume = 0.5, aggregation={max_count= 1, count_already_playing = true, remove=true}
          },
